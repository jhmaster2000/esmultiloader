...
## Install
```sh
npm i esm-multiloader
```

## Usage
```sh
node --loader loader2 --loader ./loader1.js --loader esm-multiloader file.js
```

### Optional Configuration
Options can be passed to `esm-multiloader` to configure it's behavior using the following `/` separated list syntax:
```sh
node --loader esm-multiloader/booleanoption/option=123/...
```
Where:
...
`debug` | Boolean | `false` | Enable printing of multiloader debug logs.
